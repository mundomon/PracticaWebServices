...
class bdMysql
{
	...
	{
		//$this->DBServer_ 	= "ec2-35-157-135-177.eu-central-1.compute.amazonaws.com" ;
		$this->DBServer_ 	= "practws.ch0s6hkc16m3.eu-central-1.rds.amazonaws.com";
		$this->DBUsername_ 	= "root" ;
		$this->DBPassword_ 	= "alumnosroot" ;
